...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]?) -> Bool {
        ...
        ParseSwift.initialize(applicationId: "AGBgC4Wll6QcYjHGg5pZ6BkeQuUpvkAo7fZzOpKD",
                                  clientKey: "7aEVXbLtrnQQ5W6MngSYZVWTW1X74QeM0dZavqIk",
                                  masterKey: "SVi5KeZL7PcMhqjfNZG1123IaBLIzxQbmnqUj5Lv",
                                  serverURL: URL(string: "https://parseapi.back4app.com")!,
//                                  allowingCustomObjectIds: customObjectId,
                                  usingEqualQueryConstraint: false,
                                  usingDataProtectionKeychain: false)
        
//        initializeParse(customObjectId: false)
